...
public final class MassFadeAnimator extends PropagatingAnimator<PropagatingAnimator.ViewHolder> implements Joinable {
    ...
    private MassFadeAnimator(Builder builder) {
        ...
        if(m1983xcc0e8822()[this.mDirection.ordinal()]==androidx.recyclerview.R.styleable.RecyclerView_android_descendantFocusability){
            this.mStartAlpha = 0.0f;
            this.mEndAlpha = 1.0f;
        }
        else if(m1983xcc0e8822()[this.mDirection.ordinal()]==androidx.recyclerview.R.styleable.RecyclerView_layoutManager){
