...
public class ViewDimmer {
    ...
    public float convertToDimLevel(DimState dimState) {
        switch (m1986x75d1ee2e()[dimState.ordinal()]) {
            case androidx.appcompat.recyclerview.R.styleable.RecyclerView_android_descendantFocusability:
                return this.mActiveDimLevel;
            case androidx.appcompat.recyclerview.R.styleable.RecyclerView_layoutManager:
